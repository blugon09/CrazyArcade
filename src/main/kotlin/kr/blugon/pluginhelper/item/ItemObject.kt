...
class ItemObject(var type: Material) {
...
//    val customDataTag = ArrayList<CustomDataTag>()
    ...
    //===================<Create>===================
    constructor(type: Material, amount: Int = 1) : this(type) {
        this.amount = amount
    }
    constructor(type: Material, amount: Int = 1, displayName: TextComponent? = null) : this(type) {
        this.amount = amount
        this.displayName = displayName
    }
    constructor(type: Material, amount: Int = 1, displayName: TextComponent? = null, lore: ArrayList<TextComponent> = arrayListOf()) : this(type) {
        this.amount = amount
        this.displayName = displayName
        this.lore = lore
    }
